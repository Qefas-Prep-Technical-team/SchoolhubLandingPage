                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-4">
                                <div className="flex size-12 shrink-0 items-center justify-center rounded-md bg-blue-100 text-blue-500">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Chat with us live for instant support.</p>
                    ...
                    <div className="rounded-2xl bg-white p-8 shadow-2xl lg:p-12">
                        <form action="#" className="space-y-6" method="POST">
                            <div>
                                ...
                                <input autoComplete="name" className="form-input block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-blue-500 focus:ring-blue-500" id="name" name="name" placeholder="Your Name" type="text" />
                            </div>
                            <div>
                                <label className="sr-only" htmlFor="email">Your Email</label>
                                <input autoComplete="email" className="form-input block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-blue-500 focus:ring-blue-500" id="email" name="email" placeholder="Your Email" type="email" />
                            </div>
                            <div>
                                <label className="sr-only" htmlFor="message">Your Message</label>
                                <textarea className="form-textarea block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-blue-500 focus:ring-blue-500" id="message" name="message" placeholder="Your Message" rows={6}></textarea>
                            </div>
                            <div>
